            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div 
                        ...
                        exit={{ opacity: 0, y: 10 }}
                        className="absolute top-full right-0 mt-2 w-80 sm:w-96 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-700 overflow-hidden z-[120] flex flex-col max-h-[85vh]"
                    >
                        {/* Header */}
